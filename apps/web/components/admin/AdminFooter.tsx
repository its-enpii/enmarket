...
/**
 * Footer admin — branding EnStudio + link public store.
  ...
  return (
    <footer className="border-t-4 border-ink bg-surface mt-auto">
      <div className="px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs text-ink/60">
        <p>
          <Badge tone="primary" size="sm" shadow={false} fontSize="micro" className="mr-1.5 px-1.5 py-0.5 font-bold uppercase tracking-wide">
            EnStudio
          </Badge>
