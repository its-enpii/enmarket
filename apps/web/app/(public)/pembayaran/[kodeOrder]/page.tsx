...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `Pembayaran ${kodeOrder} — enpiistudio Store`,
    description: 'Selesaikan pembayaran via QRIS Tripay.',
    robots: { index: false },
  };
}
...
export default async function PembayaranPage({ params }: PageProps) {
  ...
  try {
    ...
    // Also catch ApiRequestError from order-api (which uses different error class)
